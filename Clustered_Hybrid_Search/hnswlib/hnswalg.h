...
//                    if (candidate_id == 0) continue;
        ...
        searchKnn(const void *query_data, size_t k, BaseFilterFunctor *isIdAllowed = nullptr) const
        {
            ...
            tableint currObj = enterpoint_node_;
            dist_t curdist = fstdistfunc_(query_data, this->getDataByInternalId(enterpoint_node_), dist_func_param_);
        ...
        // Search online graph Construction

        std::priority_queue<std::pair<dist_t, labeltype>>
        searchKnnForOnlineGraphConstruction(const void *query_data, size_t k, BaseFilterFunctor *isIdAllowed = nullptr) const
        {
            std::priority_queue<std::pair<dist_t, labeltype>> result;
            if (cur_element_count == 0)
                return result;
